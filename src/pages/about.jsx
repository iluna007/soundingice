				...
				<div className='row example'>
					...
					<div className='col'>
						...
						<p>
							...
							Visual Arts (SOVA), Dawson City, Canada. Realised by Susan
							Schuppli during the winter of 2025.
						</p>
						<p>
						...
						<p>
							<strong>Supported by:</strong> Yukon School of Visual Arts, the
							Klondike Institute of Art & Culture (KIAC), Yukon University, with
							funding support from a Social Science and Humanities Research
							Council of Canada (SSHRC) Connections Grant / Toronto Biennial of
							Art.
						</p>
						<p>
							<strong>Special thanks to:</strong> Nicole Rayburn and Aubyn
							O’Grady, both instructors at SOVA and to Faiza Ahmed Khan in
							Delhi, India, my collaborator on the Listening to Ice research
							project, who was repeatedly refused a visa to travel to Canada to
							participate in this iteration of our work.
						</p>
						<p>
							<strong>Project Credits:</strong> Drone Footage by John Howland &
							Bobby. Website designed by Iker Luna.
						</p>
						...
						<p>
							Schuppli is Professor and Director of the Centre for Research
							Architecture, Goldsmiths University of London and is also an
							investigative researcher with the human rights agency Forensic
							Architecture, recipient of the 2024 Right Livelihood Award.
						</p>
						<p>
							<strong>Nicole Rayburn</strong>’s artistic practice is a
							...
							holds an MFA from the University of Western Ontario.
						</p>
						<p>
							<strong>Iker Luna</strong> is an architect and designer
							based in Costa Rica whose research explores political repression
							and state-sponsored violence in Nicaragua as expressed through the
							built environment. Iker holds an MAArch from the Institute for
							Advanced Architecture of Catalonia. He teach at the University of
							Costa Rica in the Architecture School and currently pursuing a MA
							in the Centre for Research Architecture at Goldsmiths, University
							of London.
						</p>
					</div>
					<div className='col-2'></div>
